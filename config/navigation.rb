...
SimpleNavigation::Configuration.run do |navigation|
  ...
  primary.item :incorporation, 'Incorporation', '/show/incorporation' do |sub_nav|
      ...
      sub_nav.item :commission_of_local_government, 'CLG','/show/commission_of_local_government'
    ...
    primary.item :parks_and_recreation, 'Parks & Recreation', '/show/parks_and_recreation' do |sub_nav|
      ...
      sub_nav.item :parks_and_recreation_assistance, 'P & R Assistance','/show/parks_and_recreation_assistance'
